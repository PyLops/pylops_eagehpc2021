...
# Compare timings 
nt, nx = 1000, 10
nys_post = np.arange(200, 1500, 100).astype(np.int)
...
# Compare timings 
nt, nx = 1000, 10
nys_pre = np.arange(200, 1500, 100).astype(np.int)
ntheta = 11
thetamin, thetamax = 0, 40
...
axs[1].legend()
plt.savefig('Figs/Speedup_seismicinv_float32.eps', dpi=300, bbox_inches='tight')
