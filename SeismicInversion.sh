#!/bin/bash
#
#SBATCH --job-name=pylops_cupy_seismicinv
#SBATCH --partition=batch
#SBATCH --nodes=1
#SBATCH --time=00:20:00
#SBATCH --error=pylops_cupy_seismicinv.%J.err 
#SBATCH --output=pylops_cupy_seismicinv.%J.out
#SBATCH --mem=64G
#SBATCH --gres=gpu:1
...
## Run the application:
srun python SeismicInversion.py
